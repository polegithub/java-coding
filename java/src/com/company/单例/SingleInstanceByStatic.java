 ...
 * @author Eric Cheng
 */
public class SingleInstanceByStatic {
   ...
   */
  private static SingleInstanceByStatic me = new SingleInstanceByStatic();

  private SingleInstanceByStatic() {
    System.out.println(SingleInstanceByStatic.class.getName() + " init");
  }

  public static SingleInstanceByStatic share() {
    return me;
  }
}
